...
class mdlroles{
    ...
    static public function mdlGuardarRoles($tabla,$nomRol){
        ...
        $stmt= Conexion::conectar()->prepare("INSERT INTO $tabla(nomreRol) VALUES(:NOMBRE_ROL)");
    ...
    static public function mdlEditarRoles($tabla, $nomRol , $idrol){
        ...
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nomreRol=:rol_nom WHERE id =:id");
